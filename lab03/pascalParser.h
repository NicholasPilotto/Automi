...
class pascalParser : public antlr4::Parser {
 public:
  ...
  enum { RuleStart = 0, RuleDecl_list = 1, RuleDecl = 2, RuleId_list = 3, RuleMain_code = 4, RuleCode_block = 5, RuleSt_list = 6, RuleStatement = 7, RuleAssign = 8, RuleOut = 9, RuleIn = 10, RuleBranch = 11, RuleLoop = 12, RuleExpr = 13, RuleGuard = 14, RuleRelation = 15 };
